...
function confirmacion() {
    ...
    /* para imprimir una variable en una cadena podemos utilizar las comillas simples inversas ´´ y leugo hacemos el llamado de la variable con ${aquí se escribe el nombre de la variable}*/
    alert(`Valor seleccionado ${confirmacion}`)
}

function capturarDatos() {
    let nombre = prompt("¿Cual es su nombre?");
    // En campo del promt se mostrara 0 por defecto
