...
if (intentos <= numeroIntentos) {
    ...
    // operador ternario para definir si el numero es más alto o  más bajo
    const altoBajo = (numero > numeroAleatorio) ? "bajo" : "alto";

    // Verificamos el numero ingresado por el usuario
    if (numero == numeroAleatorio) {
        ...
        mensaje = `Vuelve  a intentar. Quedan ${numeroIntentos - intentos} intentos. El numero que buscas es más ${altoBajo}.`;
    } 
