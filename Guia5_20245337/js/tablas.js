// Creación de la tabla con concatenación de cadenas
...
alumnos.forEach (alumno => {
    ...
    table += `<th scope='col'>${alumno.nombre}</th>`;
    table += `<th scope='col'>${alumno.apellido}</th>`;
    table += `<th scope='col'>${alumno.correo}</th>`;
    table += `</tr>`;
});
